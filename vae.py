from keras.layers import Input, Dense, LSTM, Lambda, Bidirectional, Concatenate, Masking, RepeatVector
...
class VAE(Model):
    def __init__(
        ...
        self.decoder = Decoder(self.input_dim, self.latent_dim, self.max_output_len)
    ...
    def vae_loss(self, y_true, y_pred):
        ...
        kl_loss = -0.5 * K.sum(1 + self.encoder.z_log_var - K.square(self.encoder.z_mean) - K.exp(self.encoder.z_log_var), axis=-1)
